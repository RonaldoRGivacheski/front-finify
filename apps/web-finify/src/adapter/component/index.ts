/**
 * The common, shared basic components, originally placed inside the adapter/form, which limited their usage, have been extracted here for easier use elsewhere.
 * Can be used for vben-form, vben-modal, vben-drawer, etc.
 */
...
/**
 * Create default upload button slots
 */
...
async function previewImage(
  ...
  // Non-image files open the link directly
  if (!isImageFile(file)) {
  ...
  // Filter image files and generate previews
...
/**
 * Upload component with preview function
 */
...
// Here you need to adapt to the business component library, and all components that need to be used need to be type-described here
...
/**
 * Corresponds one-to-one with the component names registered in {@link ComponentType}, facilitating `component` + `componentProps` linkage prompts on the Schema
 */
...
async function initComponentAdapter() {
  const components: Partial<Record<ComponentType, Component>> = {
    // If your component is large, you can use asynchronous loading
    // Button: () =>
